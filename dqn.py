...
class DeepQNetwork:
    ...
    def _build_net(self):
        ...
        with tf.variable_scope('eval_net'):
            e1 = tf.layers.dense(self.s, 150, tf.nn.relu, kernel_initializer=w_initializer,
        ...
        with tf.variable_scope('target_net'):
            t1 = tf.layers.dense(self.s_, 150, tf.nn.relu, kernel_initializer=w_initializer,
    ...
    def rival(self, observation):
        return self.sess.run(self.q_next, feed_dict={self.s_: observation[np.newaxis, :]})[0]

    def eval(self, observation):
        return self.sess.run(self.q_eval, feed_dict={self.s: observation[np.newaxis, :]})[0]

    def choose_action(self, observation, valid, n):
